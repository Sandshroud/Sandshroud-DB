...
CREATE TABLE `db_version` (
  ...
  `last_tested_sadb_revision` text COLLATE latin1_general_ci NOT NULL,
  `last_included_sadb_update` varchar(255) COLLATE latin1_general_ci NOT NULL,
...
INSERT INTO `db_version` VALUES ('SADB',1,1,'3.3.5a','none','none','armm77');
